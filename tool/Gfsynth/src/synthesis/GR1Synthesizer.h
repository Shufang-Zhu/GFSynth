#ifndef SYFT_GR1SYNTHESIZER_H
#define SYFT_GR1SYNTHESIZER_H
            ...
            while (std::getline(in, line) && (line.find("Justice-End") == std::string::npos)) {
                ...
                if (line == "true") {
                    ...
                    for (std::string token : tokens) {
                        ...
                        variable_name = boost::to_upper_copy(variable_name); // turn variable names into uppercase to match the variable names in InputOutputPartition
