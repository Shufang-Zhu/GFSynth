#ifndef SYFT_LTLFGR1SYNTHESIZER_H
#define SYFT_LTLFGR1SYNTHESIZER_H
...
namespace  Syft {
    ...
    class LTLfGR1Synthesizer{
         ...
         *
         */
        LTLfGR1Synthesizer(std::shared_ptr<VarMgr> var_mgr, GR1 gr1, SymbolicStateDfa env_safety,
...
#endif //SYFT_LTLFGR1SYNTHESIZER_H
